  ...
  def test_escreva_uma_plaquinha_longa_quando_o_nome_é_carla_toledo(self):
    self.assertEqual(escrever_plaquinha_ideal("Ing.", "Carla", "Toledo"), "Enga. Carla Toledo")
  
  def test_escreva_uma_plaquinha_longa_quando_o_nome_é_branco_luis(self):
    self.assertEqual(escrever_plaquinha_ideal("Ing.", "Branco", "Luis"), "Eng. Branco Luis")
  ...
  def test_escreva_uma_plaquinha_curta_quando_o_nome_é_katherine_boumann(self):
    self.assertEqual(escrever_plaquinha_ideal("Ing.", "Katherine", "Boumann"), "Enga. Boumann")