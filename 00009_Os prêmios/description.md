O júri de um torneio pediu que desenvolvêssemos uma função `medalha_segundo_colocacao` que retornasse a medalha que corresponde aos primeiros lugares, conforme a seguinte lógica:
